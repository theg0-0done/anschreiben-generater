...
const PRESETS = [
  ...
  { label: "Morgen um 14:00 Uhr", days: 1, hours: 14, minutes: 0, icon: Sun },
  { label: "In 2 Tagen um 09:00 Uhr", days: 2, hours: 9, minutes: 0, icon: CalendarDays },
  { label: "In 1 Woche um 09:00 Uhr", days: 7, hours: 9, minutes: 0, icon: Briefcase },
];
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {PRESETS.map((preset) => (
                      <button
                        key={preset.label}
                        type="button"
                        onClick={() => applyPreset(preset.days, preset.hours, preset.minutes)}
                        className="px-3 py-2 text-xs font-medium border border-slate-200 dark:border-slate-700 rounded-full hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-200 text-left transition-colors flex items-center gap-2"
                      >
                        <preset.icon className="w-3.5 h-3.5 shrink-0 text-slate-400 dark:text-slate-500" />
                        {preset.label}
                      </button>
                    ))}
                  </div>
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-4 sm:space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="p-4 bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-800 rounded-2xl space-y-3">
                ...
                {previewItem.status === "failed" && previewItem.error && (
                  <div className="flex items-start gap-2.5 p-3 rounded-2xl bg-rose-50 dark:bg-rose-950/40 border border-rose-200 dark:border-rose-900 text-sm text-rose-700 dark:text-rose-300">
                ...
                <div className="space-y-2">
                  ...
                  {previewItem.pdf_deleted_at ? (
                    <div className="border border-slate-200 dark:border-slate-700 rounded-2xl bg-slate-50 dark:bg-slate-800 p-6 text-center space-y-1">
                    ...
                    <div className="border border-slate-200 dark:border-slate-700 rounded-2xl overflow-hidden bg-slate-100 dark:bg-slate-800 h-96 shadow-inner">
                      <iframe
