...
export default function LoginPage() {
  ...
  const handleGoogleSignIn = async (loginHint?: string, silent: boolean = !!loginHint) => {
    ...
    try {
      ...
      // On success the browser is redirected to Google, so we stay in a loading state.
    } catch (err: any) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#f0f4f8] to-[#e0e8f0] flex items-center justify-center p-4">
      ...
      >
        ...
        <p className="text-xs text-slate-400 mt-6">
          ...
          <a href="/terms" className="underline hover:text-slate-600">Nutzungsbedingungen</a> und{" "}
          <a href="/privacy" className="underline hover:text-slate-600">Datenschutzerklärung</a>.
        </p>
      </motion.div>
    </div>
  );
