...
## Corpus Check
- 47 files · ~22,679 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 274 nodes · 398 edges · 27 communities (13 shown, 8 thin omitted)
...
- `GET()` --calls--> `buildTokenCookie()`  [EXTRACTED]
  app/api/auth/callback/route.ts → lib/gmail.ts
...
Cohesion: 0.17
Nodes (22): ApplyPage(), DashboardLayout(), ProfilePage(), UploadsPage(), OnboardingPage(), CoverLetterPDF(), CoverLetterPDFProps, styles (+14 more)
...
Cohesion: 0.40
Nodes (3): Toast(), ToastProps, ScheduledItem
...
- **Why does `insertCoverLetterPage()` connect `storage.ts` to `generate/route.ts`?**
